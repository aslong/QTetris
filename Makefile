...
# Generated by qmake (2.01a) (Qt 4.7.4) on: Mon Mar 12 17:37:12 2012
# Project:  QTetris.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/QTetris1.0.0/ && $(COPY_FILE) --parents TetrisGrid.h TetrisScene.h QTetrisWindow.h Block.h .tmp/QTetris1.0.0/ && $(COPY_FILE) --parents TetrisGrid.cpp TetrisScene.cpp QTetrisWindow.cpp Block.cpp main.cpp .tmp/QTetris1.0.0/ && (cd `dirname .tmp/QTetris1.0.0` && $(TAR) QTetris1.0.0.tar QTetris1.0.0 && $(COMPRESS) QTetris1.0.0.tar) && $(MOVE) `dirname .tmp/QTetris1.0.0`/QTetris1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/QTetris1.0.0
...
moc_TetrisGrid.cpp: TetrisGrid.h
